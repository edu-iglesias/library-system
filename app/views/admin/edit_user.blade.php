	...
	<div class="form-create col-md-12">
		...
		<div class="forms col-md-12">
			<div class="col-md-6 form-group @if ($errors->has('FirstName')) has-error @endif">
		        {{ Form::text('FirstName',Session::get('Fname'),array('class' => 'form-control', 'placeholder' => 'First Name','maxlength'=>'50')) }}
		...
		<div class="forms col-md-12">
			<div class="col-md-6 form-group @if ($errors->has('LastName')) has-error @endif">
		        {{ Form::text('LastName',Session::get('Lname'),array('class' => 'form-control', 'placeholder' => 'Last Name','maxlength'=>'50')) }}
		...
		<div class="forms col-md-12">
			<div class="col-md-6 form-group @if ($errors->has('MiddleName')) has-error @endif">
		        {{ Form::text('MiddleName',Session::get('Mname'),array('class' => 'form-control', 'placeholder' => 'Middle Name','maxlength'=>'50')) }}
		...
		<div class="forms col-md-12">
			<div class="col-md-6 form-group @if ($errors->has('UserType')) has-error @endif">
		            {{ Form::select('UserType', [''=>'Choose a User Type','2' => 'Student', '3' => 'Faculty'], Session::get('UserType'), ['class'=>'form-control'] ); }}
