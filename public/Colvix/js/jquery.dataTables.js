...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" style="margin-left:-20px" placeholder="Search" class="form-control '+classes.sFilterInput+'"/>';
				...
				var attach = function( container, buttons ) {
					...
					for ( i=0, ien=buttons.length ; i<ien ; i++ ) {
						...
						if ( $.isArray( button ) ) {
							...
							if ( btnDisplay ) {
								node = $('<a>', {
										'class': classes.sPageButton+' btn btn-default '+btnClass,
